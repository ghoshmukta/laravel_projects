    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="bg-white max-w-sm w-full p-6 rounded shadow-md">
            ...
            @csrf
                ...
                <div class="mb-4">
                    <label class="block mb-2" for="dob">Date of Birth</label>
                ...
                <div class="mb-4">
                    <label class="block mb-2" for="avatar">Avatar</label>
                ...
                <button class="w-full bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600" type="submit">Register</button>
            </form>
