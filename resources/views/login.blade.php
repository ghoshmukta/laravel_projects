...
<body class="bg-gray-100">
    <div class="min-h-screen flex items-center justify-center">
        <div class="bg-white max-w-sm w-full p-6 rounded shadow-md">
            <h2 class="text-2xl font-bold mb-6 border-dashed border-double border-4 border-indigo-600 p-1.5 text-center">Login</h2>
            <form action="{{ route('login.submit') }}" method="POST">
                ...
                @endif
                <div class="mb-6">
                    <label class="block mb-2 text-bold text-[20px]" for="email">Email</label>
                ...
                <div class="mb-6">
                    <label class="block mb-2 text-bold text-[20px]" for="password">Password</label>
            ...
            <div class="flex justify-end mt-2">
                <a href="{{ route('reset') }}" class="text-blue-500 hover:underline text-sm mt-2">Forget password</a>
            </div>

            <div class="flex justify-end mt-2">
                <a href="{{ route('register') }}" class="text-blue-500 hover:underline mt-1">New user? Register</a>
            </div>
